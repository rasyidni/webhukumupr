        ...
        <div class="col-lg-12">
            <div class="banner-nav">
                <div class="banner-box">
                    <a href="#">Halaman </a>
                    <a href="#">Kementerian Kewirausahaan</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-3 col-sm-6">
                <div class="card card-block">
                    <a href="#"><img alt="" class="team-img" src="{{ asset('foto.jpeg') }}">
                        <div class="card-title-wrap">
                            <span class="card-title">John P. Haight</span> <span class="card-text">Direktur Jenderal Pembinaan Usaha</span>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card card-block">
                    <a href="#"><img alt="" class="team-img" src="{{ asset('foto.jpeg') }}">
                        <div class="card-title-wrap">
                            <span class="card-title">John P. Haight</span> <span class="card-text">Direktur Jenderal Penjualan</span>
                        </div>
                    </a>
                </div>
            </div>
