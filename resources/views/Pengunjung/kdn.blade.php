        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card card-block">
                    <a href="#"><img alt="" class="team-img" src="{{ asset('foto.jpeg') }}">
                        <div class="card-title-wrap">
                            <span class="card-title">David R. Bernard</span> <br> <span class="card-text">Direktur Jenderal Statistik</span>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card card-block">
                    <a href="#"><img alt="" class="team-img" src="{{ asset('foto.jpeg') }}">
                        <div class="card-title-wrap">
                            <span class="card-title">David R. Bernard</span> <span class="card-text">Direktur Jenderal Urusan Akademik & Kemahasiswaan</span>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card card-block">
                    <a href="#"><img alt="" class="team-img" src="{{ asset('foto.jpeg') }}">
                        <div class="card-title-wrap">
                            <span class="card-title">David R. Bernard</span> <span class="card-text">Direktur Jenderal Urusan Ormawa & UKM</span>
                        </div>
                    </a>
                </div>
            </div>
