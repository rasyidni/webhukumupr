  ...
  <!-- Content Header (Page header) -->
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0 text-dark">Halaman Kementerian Koordinator Politik dan Hukum</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <form action="/editkkpolitik/1" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nama Direktur Jenderal Hukum</label>
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Gambar Direktur Jenderal Hukum</label>
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nama Direktur Jenderal Politik dan Hubungan Antar Partai Politik</label>
                <input type="text" name = "nama_dpolitik" class="form-control @error('nama_dpolitik') is-invalid @enderror" id="exampleInputEmail1" value="{{ $data -> nama_dpolitik }}">
                @error('nama_dpolitik')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Gambar Direktur Jenderal Politik dan Hubungan Antar Partai Politik</label>
                <input type="hidden" name="oldImagedp" value="{{ $data -> gambar_dpolitik }}">
                @if ($data -> gambar_dpolitik)
                <img src="{{ asset('storage/'.$data -> gambar_dpolitik) }}" class="img-previewdp img-fluid mb-3 col-sm-5 d-block">
                @else
                <img class="img-previewdp img-fluid mb-3 col-sm-5 ">
                @endif
                
                <input type="file" id="gambar_dpolitik" name="gambar_dpolitik" class="form-control @error('gambar_dpolitik') is-invalid @enderror" value="{{ $data -> gambar_dpolitik }}" onchange="previewImagedp()">
                @error('gambar_dpolitik')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
                @enderror
    ...
    <script>
      ...
      function previewImagedp(){
        const gambar = document.querySelector('#gambar_dpolitik');
