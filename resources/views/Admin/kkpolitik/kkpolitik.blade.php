  ...
  <!-- Content Header (Page header) -->
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0 text-dark">Halaman Kementerian K. Politik dan Hukum</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="container-fluid">
      <div class="card">
        ...
        <div class="card-body p-5">
          <div class="row d-flex justify-content-center align-items-center h-100 gx-5 p-3">
            ...
            <div class="col-md-3">
              <div class="card" style="border-radius: 15px; height: 18rem;">
                <div class="card-body text-center">
                  ...
                  <h6 class="mb-2">Direktur Jenderal Hukum</h6>
            ...
            <div class="col-md-3">
                  <div class="card" style="border-radius: 15px; height: 18rem;">
                    <div class="card-body text-center">
                        <img src="{{ asset('storage/'. $data->gambar_dpolitik) }}"
                        class="rounded-circle img-fluid" style="width: 200px;" />
                      </br>
                    </br>
                      <h6 class="mb-2">Direktur Jenderal Politik dan Hubungan Antar Partai Politik</h6>
                      <p class="text-muted mb-4">{{ $data->nama_dpolitik }}</p>
                    </div>
                  </div>
            </div>
          </div>
        ...
        <div class="card-footer">
          <a href="/tampilkankkpolitik/1" type="button" class="btn btn-primary float-left"><i ></i>Edit Data</a>
        </div>
      </div>
    </div>
  </div>
