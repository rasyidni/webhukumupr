  ...
  <!-- Content Header (Page header) -->
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0 text-dark">Halaman Kementerian Pemuda dan Olahraga</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <form action="/editkpemuda/1" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nama Direktur Jenderal Keolahragaan</label>
                <input type="text" name = "nama_dolahraga" class="form-control @error('nama_dolahraga') is-invalid @enderror" id="exampleInputEmail1" value="{{ $data -> nama_dolahraga }}">
                @error('nama_dolahraga')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
                @enderror
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Gambar Direktur Jenderal Keolahragaan</label>
                <input type="hidden" name="oldImagedo" value="{{ $data -> gambar_dolahraga }}">
                @if ($data -> gambar_dolahraga)
                <img src="{{ asset('storage/'.$data -> gambar_dolahraga) }}" class="img-previewdo img-fluid mb-3 col-sm-5 d-block">
                @else
                <img class="img-previewdo img-fluid mb-3 col-sm-5 ">
                @endif
                
                <input type="file" id="gambar_dolahraga" name="gambar_dolahraga" class="form-control @error('gambar_dolahraga') is-invalid @enderror" value="{{ $data -> gambar_dolahraga }}" onchange="previewImagedo()">
                @error('gambar_dolahraga')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
                @enderror
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nama Direktur Jenderal Kepemudaan</label>
                <input type="text" name = "nama_dpemuda" class="form-control @error('nama_dpemuda') is-invalid @enderror" id="exampleInputEmail1" value="{{ $data -> nama_dpemuda }}">
                @error('nama_dpemuda')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Gambar Direktur Jenderal Kepemudaan</label>
                <input type="hidden" name="oldImagedp" value="{{ $data -> gambar_dpemuda }}">
                @if ($data -> gambar_dpemuda)
                <img src="{{ asset('storage/'.$data -> gambar_dpemuda) }}" class="img-previewdp img-fluid mb-3 col-sm-5 d-block">
                @else
                <img class="img-previewdp img-fluid mb-3 col-sm-5 ">
                @endif
                
                <input type="file" id="gambar_dpemuda" name="gambar_dpemuda" class="form-control @error('gambar_dpemuda') is-invalid @enderror" value="{{ $data -> gambar_dpemuda }}" onchange="previewImagedp()">
                @error('gambar_dpemuda')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
                @enderror
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nama Direktur Jenderal Seni & Olahraga</label>
                <input type="text" name = "nama_dso" class="form-control @error('nama_dso') is-invalid @enderror" id="exampleInputEmail1" value="{{ $data -> nama_dso }}">
                @error('nama_dso')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Gambar Direktur Jenderal Seni & Olahraga</label>
                <input type="hidden" name="oldImagedso" value="{{ $data -> gambar_dso }}">
                @if ($data -> gambar_dso)
                <img src="{{ asset('storage/'.$data -> gambar_dso) }}" class="img-previewdso img-fluid mb-3 col-sm-5 d-block">
                @else
                <img class="img-previewdso img-fluid mb-3 col-sm-5 ">
                @endif
                
                <input type="file" id="gambar_dso" name="gambar_dso" class="form-control @error('gambar_dso') is-invalid @enderror" value="{{ $data -> gambar_dso }}" onchange="previewImagedso()">
                @error('gambar_dso')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
    ...
    <script>
      ...
      function previewImagedo(){
        const gambar = document.querySelector('#gambar_dolahraga');
        const imgPreview = document.querySelector('.img-previewdo');
      ...
      function previewImagedp(){
        const gambar = document.querySelector('#gambar_dpemuda');
      ...
      function previewImagedso(){
        const gambar = document.querySelector('#gambar_dso');
        const imgPreview = document.querySelector('.img-previewdso');
